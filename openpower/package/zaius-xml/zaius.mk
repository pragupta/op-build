...
ZAIUS_XML_VERSION ?= 72eafd90aedb9432daf310dcd6e373308570bcd5
...
define ZAIUS_XML_BUILD_CMDS
       ...
       $(MRW_HB_TOOLS)/filter_out_unwanted_attributes.pl \
            ...
            --mrw-xml $(MRW_SCRATCH)/ZAIUS_hb.mrw.xml

       cp  $(MRW_SCRATCH)/ZAIUS_hb.mrw.xml.updated  $(MRW_SCRATCH)/ZAIUS_hb.mrw.xml
